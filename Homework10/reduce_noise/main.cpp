...
int main()
{
	...
	// Load models
	//ourModel = model("noiseBunny.obj");
	Model noiseModel("noiseBunny.obj");
	ourModel = noiseModel;
	// Draw in wireframe
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(lightPosLoc,4.0f,2.0f,2.0f);
		...
		glm::mat4 weight;
		model = glm::scale(weight, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(glGetUniformLocation(shader.Program, "weigth"), 1, GL_FALSE, glm::value_ptr(weight));
