...
void MainWindow::CreateActions()
{
	...
	action_local_ = new QAction(tr("MinimalSurface(LocalWay)"), this);
	connect(action_local_, SIGNAL(triggered()), renderingwidget_, SLOT(minimalSurfaceLocal()));

	action_global_ = new QAction(tr("MinimalSurface(GlobalWay)"), this);
	connect(action_global_, SIGNAL(triggered()), renderingwidget_, SLOT(minimalSurfaceGlobal()));
...
void MainWindow::CreateMenus()
{
	...
	mymenu_->addAction(action_local_);
	mymenu_->addAction(action_global_);
...
void MainWindow::CreateToolBars()
{
	...
	mytoolbar_->addAction(action_local_);
	mytoolbar_->addAction(action_global_);
